...
Configuration
Set your WiFi SSID and password in the source file (ssid[] and pass[]).

Insert your Blynk authentication token in the BLYNK_AUTH_TOKEN variable.

Confirm pin definitions match your hardware wiring.
...
Parameter	Optimal Range	Suboptimal	Poor/Dangerous
...
Let me know if you want a markdown file (.md) with this content or if you'd like me to include instructions for extending the project or setting up the Blynk dashboard!
